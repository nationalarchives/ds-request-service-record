...
import { continueFromWhatWasTheirDateOfBirth } from "../lib/step-functions";
...
test.describe("the 'What was their date of birth?' form", () => {
  ...
  test.describe("with valid input, the user is taken to the correct next page", () => {
    const validSubmissionMappings = [
      {
        ...
        shouldValidate: true,
        description:
          "when the year of birth is 1890, the 'Tell us as much as you know about the service person' page is shown and 'Back' links work as expected",
      },
      {
        month: "01",
        day: "01",
        ...
        shouldValidate: true,
        description:
          "when the year of birth is 1950, the 'We do not have records for people born after 1939' page is shown and 'Back' links work as expected",
      },
      {
        month: "01",
        day: "01",
        ...
        shouldValidate: true,
        description:
          "when the year of birth is 1925, the 'Provide proof of death' page is shown and 'Back' links work as expected",
      },
    ];

    validSubmissionMappings.forEach(
      ({ day, month, year, nextUrl, shouldValidate, description }) => {
