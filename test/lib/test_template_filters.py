...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            'My favorite search engine is <a href="https://duckduckgo.com" target="_blank" rel="noreferrer noopener">Duck Duck Go</a>',
        ),
        ("No links here!", "No links here!"),
        (
            "Multiple: [Google](https://google.com) and [Bing](https://bing.com)",
            'Multiple: <a href="https://google.com" target="_blank" rel="noreferrer noopener">Google</a> and <a href="https://bing.com" target="_blank" rel="noreferrer noopener">Bing</a>',
        ),
        (
        ...
        ("[Just a link](http://only.com)", '<a href="http://only.com" target="_blank" rel="noreferrer noopener">Just a link</a>'),
