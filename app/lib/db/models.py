...
class ServiceRecordRequest(db.Model):
    ...
    forenames = db.Column(db.String(100))
    last_name = db.Column(db.String(100))
    mod_reference = db.Column(db.String(64), nullable=True)
    catalogue_reference = db.Column(db.String(64), nullable=True)
    other_last_names = db.Column(db.String(100), nullable=True)
    place_of_birth = db.Column(db.String(128), nullable=True)
    regiment = db.Column(db.String(100), nullable=True)
    requester_address1 = db.Column(db.String(250))
    requester_address2 = db.Column(db.String(250), nullable=True)
    ...
    requester_first_name = db.Column(db.String(100), nullable=True)
    requester_last_name = db.Column(db.String(100))
    requester_postcode = db.Column(db.String(32), nullable=True)
    requester_town_city = db.Column(db.String(80))
