...
from app.lib.decorators.with_endpoint_saved_to_journey_history import (
...
def start(form, state_machine):
    ...
    return render_template(
        "main/request_a_military_service_record.html",
        form=form,
...
def how_we_process_requests(form, state_machine):
    ...
    return render_template(
        "main/how-we-process-requests.html",
        form=form,
        content=load_content(),
        back_link=get_back_link(),
    )
...
def you_have_cancelled_your_request():
    return render_template(
        "main/you-have-cancelled-your-request.html",
        content=load_content(),
        back_link=get_back_link(),
    )
